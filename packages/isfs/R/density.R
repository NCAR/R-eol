...
# Density of air
# --------------
dat.rho.air <- function(what,cache=F,robust=dpar("robust"),...)
{
...
dat.rhoDry <- function(what,cache=F,robust=dpar("robust"),pmatch=3,...)
{
...
dat.rho.dry <- function(what,cache=F,robust=dpar("robust"),...)
{
