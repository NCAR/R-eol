plotdat.ts <- function(data,data2, select, rfrnc, nsmth, ylim, yaxt, logy=F, 
                       type="l", lgnd.loc=F, plot.clipped=T, chksum=F, 
...
# lgnd.loc = T enables (time consuming) auto location of legend 
#            otherwise legend plotted in upper-left-hand corner
